...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "CHANGELOG.md", "Gemfile", "Gemfile.lock", "LICENSE", "README.md", "Rakefile", "jquery-rails.gemspec", "lib/generators/jquery/install/install_generator.rb", "lib/jquery-rails.rb", "lib/jquery/assert_select.rb", "lib/jquery/rails.rb", "lib/jquery/rails/engine.rb", "lib/jquery/rails/version.rb", "vendor/assets/javascripts/jquery-ui.js", "vendor/assets/javascripts/jquery-ui.min.js", "vendor/assets/javascripts/jquery.js", "vendor/assets/javascripts/jquery.min.js", "vendor/assets/javascripts/jquery_ujs.js"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>, [">= 3.1.0", "< 5.0"])
      s.add_runtime_dependency(%q<thor>, ["~> 0.14"])
    else
      s.add_dependency(%q<railties>, [">= 3.1.0", "< 5.0"])
